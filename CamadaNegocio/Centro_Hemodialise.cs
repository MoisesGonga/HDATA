...
namespace CamadaNegocio
{
    public class Centro_Hemodialise
    {
        ...
        public Funcionario ConsultarFuncionarioID(int IdFuncionario)
        {
            ...
            {
                acessoDadosPostgreSQL.LimparParametros();
                acessoDadosPostgreSQL.AdicionarParametro("$1", IdFuncionario);

                DataTable DataTableUsuario = acessoDadosPostgreSQL.ExecututarConsulta(CommandType.StoredProcedure, "func_consultar_funcionario_id");
                if (DataTableUsuario != null)
                {
                    funcionario = new Funcionario();
                    DataRow item = DataTableUsuario.Rows[0];
                    //user.IdUsuario = Convert.ToInt32(item["$1"]);
                    //user.NomeUsuario = Convert.ToString(item["$2"]);
        ...
        public List<Proveniencia> ListaProveniencia()
        {
            List<Proveniencia> listaProveniencia = new List<Proveniencia>();
            DataTable DataTableProveniencia = acessoDadosPostgreSQL.ExecututarConsulta(CommandType.Text, "select \"idProveniencia\" as idproveniencia, nome, descricao from \"Proveniencia\"");
        ...
        {
            acessoDadosPostgreSQL.LimparParametros();
            acessoDadosPostgreSQL.AdicionarParametro("$1", p.Nome_Proveniencia);
            acessoDadosPostgreSQL.AdicionarParametro("$2", p.Descricao);
            object rt = acessoDadosPostgreSQL.ExecututarManipulacao(CommandType.StoredProcedure, "func_cadastrar_proveniencia");
            acessoDadosPostgreSQL.LimparParametros();
        ...
        public void ActualizarProveniencia(Proveniencia p)
        {
            ...
            acessoDadosPostgreSQL.LimparParametros();
            //select func_actualizar_proveniencia(2,'Nefrologia','Nova Descrição')
            acessoDadosPostgreSQL.AdicionarParametro("$1", p.Id_Proveniencia);
            acessoDadosPostgreSQL.AdicionarParametro("$2", p.Nome_Proveniencia);
            acessoDadosPostgreSQL.AdicionarParametro("$3", p.Descricao);
            acessoDadosPostgreSQL.ExecututarManipulacao(CommandType.StoredProcedure, "func_actualizar_proveniencia");
            acessoDadosPostgreSQL.LimparParametros();
        }
        ...
        public Proveniencia EliminarProveniencia(Proveniencia p)
        {
            ...
            acessoDadosPostgreSQL.LimparParametros();
            //select func_actualizar_proveniencia(2,'Nefrologia','Nova Descrição')
            acessoDadosPostgreSQL.AdicionarParametro("id_proveniencia_", p.Id_Proveniencia);
            acessoDadosPostgreSQL.ExecututarManipulacao(CommandType.StoredProcedure, "func_eliminar_proveniencia");
            acessoDadosPostgreSQL.LimparParametros();
            return p;
        }
